package com.codeyyt.gulimall.cart.controller;

import com.codeyyt.gulimall.cart.interceptor.CartInterceptor;
import com.codeyyt.gulimall.cart.service.CartService;
...
public class CartController {
    ...
    public String addToCart(@RequestParam("skuId") Long skuId, @RequestParam("num") Integer num, RedirectAttributes redirectAttributes) throws ExecutionException, InterruptedException {
        ...
        return "redirect:http://localhost:88/api/cart/addToCartSuccess.html";
    }
    ...
    public String checkItem(@RequestParam("skuId")Long skuId,@RequestParam("check") Integer check){
        ...
        return "redirect:http://localhost:88/api/cart/cart.html";
